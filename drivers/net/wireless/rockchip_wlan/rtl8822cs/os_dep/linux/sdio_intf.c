...
#ifdef CONFIG_WIFI_BUILD_MODULE //KO模式走这里
module_init(rockchip_wifi_init_module_rtkwifi);
module_exit(rockchip_wifi_exit_module_rtkwifi);
#else
#ifdef CONFIG_WIFI_LOAD_DRIVER_WHEN_KERNEL_BOOTUP //buildin模式走这里
late_initcall(rockchip_wifi_init_module_rtkwifi); //late_initcall延迟加载，等待文件系统准备好
module_exit(rockchip_wifi_exit_module_rtkwifi);
#else
